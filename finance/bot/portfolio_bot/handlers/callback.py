...
# from bot.portfolio_bot.models.operations import delete_operation
# from bot.portfolio_bot.models.category import save_key_for_subcategory
# from bot.portfolio_bot.models.operations import write_operation_callback
# from bot.portfolio_bot.models.operations import update_date_operation
...
#     inline = kb.inline_get_date_update_operation(
#         type_operation, int(id_operation), type_month)
...
def register_callback_handlers(dp: Dispatcher):
    ...
    # dp.register_callback_query_handler(get_all_operations, Text(
    #     startswith='allO_'))  # allO - все операции
    # dp.register_callback_query_handler(
    #     get_reports_by_days, Text(startswith='byD_'))  # byD - по дням
    # dp.register_callback_query_handler(
    #     get_report_month_of_year, Text(startswith='repyear_'))
    # dp.register_callback_query_handler(
    #     do_operation, Text(startswith='wo_'))  # write operation
    # dp.register_callback_query_handler(
    #     enter_currency_for_oper, Text(startswith='gc_'))  # get currency

    # dp.register_callback_query_handler(
    #     enter_delete_operation, Text(startswith='do_'))  # Delate operation
    # dp.register_callback_query_handler(
    #     enter_update_operation, Text(startswith='ud_'))
    # dp.register_callback_query_handler(
    #     get_button_for_update_operation, Text(startswith='gdu_'))
    # dp.register_callback_query_handler(
    #     get_button_subcategory, Text(startswith='gsc_'))  # get subcat
    # dp.register_callback_query_handler(
    #     write_key_subcategory, Text(startswith='sksc_'))  # save key subcat

    # dp.register_callback_query_handler(
    #     get_visualization, Text(startswith='v_'))  # ВИЗУАЛИЗАЦИЯ
