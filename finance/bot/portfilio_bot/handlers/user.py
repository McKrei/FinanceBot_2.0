...
from bot.portfolio_bot.models.currency import dict_currency_reduction
from bot.portfolio_bot.models.user import list_telegrams_id
from bot.portfolio_bot.models.currency import dict_currency_reduction_for_search
from bot.portfolio_bot.models.money import answer_for_user_money
from bot.portfolio_bot.models.category import creating_dict_for_search_category
from bot.portfolio_bot.models.category import answer_for_user_category
from bot.portfolio_bot.models.operations import conversion_operation
from bot.portfolio_bot.models.operations import account_operation
from bot.portfolio_bot.models.operations import get_detail_operation_info
...
def register_user_handlers(dp: Dispatcher):
    dp.register_message_handler(get_detail_operation, Text(
        startswith='/d_'))  # do - detail_operation
